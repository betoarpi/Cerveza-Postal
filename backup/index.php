...
<!--[if gt IE 8]><!--> <html class="no-js" lang="es"> <!--<![endif]-->
    <head>
        ...
        <meta name="keywords" content="cervezas artesanales mexicanas, cervezas importadas, cervezas, tienda en línea, ciudad de Querétaro, venta de cerveza online, entrega de cervezas a domicilio, Querétaro, Qro.">
    ...
    <body>
        ...
        <div class="mainWrapper">
	        ...
	        <form class="contactForm" action="form-submit.php" method="post">
	        	<legend><h4>Pronto estará disponible en México nuestro servicio de venta de cervezas artesanales mexicanas e importadas por suscripción.</h4></legend>
	        	<p>¿Quieres recibir a tu domicilio la mejor selección de cervezas?<br>Déjanos tus datos y te mantendremos informado.</p>
                <div class="formRow">
                    <label>Nombre</label>
	        	...
	        	<div class="formRow">
                    <label>Email</label>
                    <input class="formField" id="email" name="email" type="email" placeholder="direccion@cervezapostal.mx">
