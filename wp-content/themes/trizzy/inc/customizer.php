...
body input[name="update_cart"]:hover, #filters a.selected, .widget.woocommerce ul.product-categories > li.current-cat-parent.has-sublist > a { background-color: <?php echo $custom_main_color; ?>; }
...
$simplebg = ot_get_option('pp_shop_search_bg');
?>
.home-contact {
