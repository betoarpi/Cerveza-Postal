...
class trizzy_tabbed extends WP_Widget {
    ...
    function trizzy_tabbed() {
        ...
        $this->WP_Widget('trizzy_tabbed', 'Trizzy Tabbed Widget', $widget_ops, $control_ops);
    }
...
class Trizzy_NS_Widget_MailChimp extends WP_Widget {
    ...
    public function Trizzy_NS_Widget_MailChimp () {
        ...
        $this->WP_Widget('trizzy_ns_widget_mailchimp', __('Trizzy MailChimp List Signup', 'trizzy'), $widget_options);
