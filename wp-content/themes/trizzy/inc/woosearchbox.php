...
<section class="woo-search">
    <form method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>" role="search">
        ...
        <div class="woo-search-elements clearfix">
            ...
            <div class="widget_price_filter clearfix">
                <div class="price_slider_wrapper">
                    <div class="price_slider_amount">
                        <input type="text" id="min_price" name="min_price" value="<?php echo esc_attr( $min_price ) ?>" data-min="<?php echo esc_attr( $min ); ?>" placeholder="<?php _e('Min price','trizzy'); ?>" />
                        <input type="text" id="max_price" name="max_price" value="<?php echo esc_attr( $max_price ) ?>" data-max="<?php echo esc_attr( $max ); ?>" placeholder="<?php _e('Max price','trizzy'); ?>" />
