...
?>
<div class="eight columns cart_totals <?php if ( WC()->customer->has_calculated_shipping() ) echo 'calculated_shipping'; ?>">

	<?php do_action( 'woocommerce_before_cart_totals' ); ?>
	<h3 class="headline"><?php _e( 'Cart Totals', 'woocommerce' ); ?></h3><span class="line"></span><div class="clearfix"></div>

	<table cellspacing="0" class="cart-table margin-top-5">
