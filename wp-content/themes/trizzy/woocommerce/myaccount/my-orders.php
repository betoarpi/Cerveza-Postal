...
if ( $customer_orders ) : ?>
	...
	<h3 class="headline margin-top-20"><?php echo apply_filters( 'woocommerce_my_account_my_orders_title', __( 'Recent Orders', 'woocommerce' ) ); ?></h3><span class="line margin-bottom-35"></span><div class="clearfix"></div>
